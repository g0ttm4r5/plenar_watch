...
label_hinweis1 = Label(start_fenster, text='Mit Hilfe von PlenarWatch können .... Beschreibung ',
...
label_hinweis1 = Label(start_fenster, text='Bitte einen Namen eingeben (Nachname, Vorname) oder einen Namen auswählen',
                       font=('Calibri', 11, 'italic'))
...
lambda ist eine "Einmalfunktion", die eine Eingabe (hier die Methode mit Argumenten) entgegen nimmt
und wieder zurück gibt. Über diesen "Umweg" ist es möglich, einem Ereignis eine Methode mit Argumenten
...
label_hinweis2 = Label(start_fenster,
                       text='Bitte für Politiker:in A und B jeweils einen Namen eingeben (Nachname, Vorname) oder einen Namen auswählen',
                       font=('Calibri', 11, 'italic'))
